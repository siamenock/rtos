...
ifeq ($(config),debug)
  ...
  ext_config = debug
  lwip_config = debug
  collection_config = debug
  collectiontest_config = debug
  lib_config = debug
  loader_config = debug
  kernel_config = debug
  linux_config = debug
...
ifeq ($(config),release)
  ...
  ext_config = release
  lwip_config = release
  collection_config = release
  collectiontest_config = release
  lib_config = release
...
ifeq ($(config),linux)
  ...
  ext_config = linux
  lwip_config = linux
  collection_config = linux
  collectiontest_config = linux
  lib_config = linux
  loader_config = linux
  kernel_config = linux
  linux_config = linux
...
PROJECTS := hal tlsf ext lwip collection collectiontest lib loader kernel linux virtio fat driver build
...
collection:
ifneq (,$(collection_config))
	@echo "==== Building collection ($(collection_config)) ===="
	@${MAKE} --no-print-directory -C lib/collection -f collection.make config=$(collection_config)
endif

collectiontest: collection
ifneq (,$(collectiontest_config))
	@echo "==== Building collectiontest ($(collectiontest_config)) ===="
	@${MAKE} --no-print-directory -C lib/collection -f collectiontest.make config=$(collectiontest_config)
endif
...
clean:
	...
	@${MAKE} --no-print-directory -C lib/collection -f collection.make clean
	@${MAKE} --no-print-directory -C lib/collection -f collectiontest.make clean
