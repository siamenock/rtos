...
#define LOCAL_MALLOC_POOL_SIZE	0x1000000	//16MByte
static char ___malloc_pool[LOCAL_MALLOC_POOL_SIZE];
...
// 	__malloc_pool = (void*)start;
 	__malloc_pool = (void*)___malloc_pool;

	init_memory_pool((uint32_t)LOCAL_MALLOC_POOL_SIZE, __malloc_pool, 0);
