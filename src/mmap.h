...
#define DESC_TABLE_AREA_START		(0x200000)    /* 2 MB */
#define DESC_TABLE_AREA_END		(0x300000)    /* 3 MB */

#define GDTR_ADDR			(0x200000)
 ...
 **/
#define KERNEL_TEXT_AREA_START		(0x400000)	/* 4 MB */
#define KERNEL_TEXT_AREA_SIZE		0x200000	/* 2 MB */
#define KERNEL_TEXT_AREA_END		(0x600000)  /* 6 MB */

/*
 * Kernel data area (6M ~ 8M)
 **/
#define KERNEL_DATA_AREA_START		(0x600000)    /* 6 MB */
#define KERNEL_DATA_AREA_END		(0x800000)    /* 8 MB */

// End of kernel - defined in linker script
extern char __bss_end[];

#define KERNEL_DATA_START		(0x600000)    /* 6 MB */
