...
static uint64_t test_values[] = { 0x0, 0xf, 0x10, 0xff, 0x100, 0xffff, 0x10000, 0x7fffffff, 0x80000000, 0xffffffff, 0x100000000, 0xfffffffffffffff, 0x1000000000000000, 0xffffffffffffffff };
 ...
 *
 * NOTE: "parse_uint#" function has a constraint about maximum. If the hax value is over 0xfffffffffffffff(f x 15, 15bit), all of returned values fixed 0xfffffffffffffff(15bit).
...
static void set_integer_str() {
	...
	snprintf(integer_str[13], STR_SIZE, "0xffffffffffffffff");
}
